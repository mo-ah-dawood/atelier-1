...
class RejectedOrderPage extends StatefulWidget {
  Order order;
  RejectedOrderPage({ this.order});
  @override
  _RejectedOrderPageState createState() => _RejectedOrderPageState();
}

class _RejectedOrderPageState extends State<RejectedOrderPage> {
  initState() {
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: DetailsWithCustomBottomSheet(
                            ...
                            bodyBottomSheet:
                                bodBottomSheet(context, widget.order)),
                      ),
                    ],
                  ),
                ),
    ...
    children: <Widget>[
     Container(
      ...
      Padding(
        ...
        child: Text(
AppLocalizations.of(context).tr("myOrders.reasonR"),          style: TextStyle(fontSize: 14, color: hint),
        ),
      ),
      SizedBox(
        height: 10,
